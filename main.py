...
BG = pygame.transform.scale(pygame.image.load("image/background.jpg"), (WIDTH, HEIGHT))
PLANET = pygame.transform.scale(pygame.image.load("image/IMG_3382.png"), (PLANET_SIZE*2, PLANET_SIZE*2))
...
def main():
    ...
    while running:
        ...
        for envet in pygame.event.get():
            ...
            if envet.type == pygame.MOUSEBUTTONDOWN:
                if temp_obj_pos:
